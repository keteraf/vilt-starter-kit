...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model {        /**
         ...
         *
         * @template TMethodValue
         * @param mixed $id
         * @param (\Closure(): TMethodValue)|list<string>|string $columns
         * @param (\Closure(): TMethodValue)|null $callback
         ...
         *
         * @template TMethodValue
         * @param (\Closure(): TMethodValue)|list<string> $columns
         * @param (\Closure(): TMethodValue)|null $callback
         * @return TModel|TMethodValue
         * @static
         */
